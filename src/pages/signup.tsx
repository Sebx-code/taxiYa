          ...
          <div className="space-y-6">
            <div className="space-y-4">
              ...
              <p className="text-slate-300 text-lg max-w-md">
                Créez votre compte en quelques secondes et accédez à un service
                de taxi premium disponible 24/7.
              </p>
            </div>
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="text-center space-y-2">
            ...
            <p className="text-slate-600">
              Rejoignez TaxiYa et profitez de nos services premium
            </p>
          </div>
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div className="flex items-start gap-2">
              <input
                ...
                className="w-4 h-4 mt-1 rounded border-slate-300 text-amber-500 focus:ring-2 focus:ring-amber-200"
              />
            ...
            <button 
              type="submit"
              className="w-full bg-linear-to-r from-amber-400 to-amber-500 hover:from-amber-500 hover:to-amber-600 text-slate-900 font-semibold py-4 rounded-xl transition-all duration-300 hover:scale-[1.02] hover:shadow-xl shadow-lg"
            >
              Créer mon compte
            </button>
